...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-[#DDE3E9] bg-[#0B1F33] text-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1.3fr_1fr] lg:px-8">
        <div>
          <p className="text-lg font-bold">Brian M. Burudi</p>
          <p className="mt-1 text-sm text-white/75">B2B Sales Lead</p>
          <p className="mt-4 max-w-xl text-sm leading-6 text-white/70">Building commercially strong partnerships for sustainable growth.</p>
        </div>
